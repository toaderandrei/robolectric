...
public class ShadowDynamicsProcessingTest {
  ...
  public void getConfig_sameAsInCtor() {
    ...
    ShadowDynamicsProcessing shadowDynamicsProcessing = Shadows.shadowOf(dynamicsProcessing);

    assertConfigBandCountsEquals(shadowDynamicsProcessing.getConfig(), oneChannelConfig);
  }
  ...
  public void getConfig_configNullInCtor_returnsNonNull() {
    ...
    DynamicsProcessing.Config config = Shadows.shadowOf(dynamicsProcessing).getConfig();
  ...
  public void getPreEqByChannelIndex_returnsSamePreEqAsConfigFromCtor() {
    ...
    Eq preEq = Shadows.shadowOf(dynamicsProcessing).getPreEqByChannelIndex(/* channelIndex= */ 0);
  ...
  public void getPreEqBandByChannelIndex_returnsSameBandAsConfigFromCtor() {
    ...
    for (int bandIndex = 0; bandIndex < preEqConfig.getPreEqBandCount(); bandIndex++) {
      EqBand actualBand =
          Shadows.shadowOf(dynamicsProcessing)
              .getPreEqBandByChannelIndex(/* channelIndex= */ 0, /* band= */ bandIndex);
      EqBand expectedBand =
          preEqConfig.getPreEqBandByChannelIndex(/* channelIndex= */ 0, /* band= */ bandIndex);
      assertEqBandEquals(actualBand, expectedBand);
    }
